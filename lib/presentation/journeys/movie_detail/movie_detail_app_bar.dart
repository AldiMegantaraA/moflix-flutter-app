          ...
          builder: (context, state) {
            if (state is IsFavoriteMovie) {
              return GestureDetector(
                ...
                child: state.isMovieFavorite
                    ? Icon(Icons.favorite, color: Colors.red, size: Sizes.dimen_16.h,)
                    : Icon(Icons.favorite_border, color: Colors.white, size: Sizes.dimen_16.h,)
              );
            } else {
              return Icon(
